...
export default function DirectorPage() {
  ...
  const handleLogin = () => {
    router.push("/director/autenticacion");
  };

  const handleRegister = () => {
    // Redirige a la nueva página de registro del director
    router.push("/director/registro");
  };
      ...
      >
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', width: '100%' }}>
            <label htmlFor="codigoProfesional" style={{ color: '#1a1a1a', fontSize: '1rem' }}>
              Código profesional:
            </label>
            <input 
              type="text" 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%', maxWidth: '16rem', marginTop: '1rem' }}>
          <button
            onClick={handleLogin}
            style={{
              width: '100%',
